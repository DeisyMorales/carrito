                            ...
                            <div class="row">
                                ...
                                <form action="">
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <input type="text" name="nombres" class="form-control col-lg-8 col-md-8 col-sm-12" readonly>
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <input type="number" name="dni" id="producto" class="form-control col-lg-4 col-md-4 col-sm-12" required placeholder="dni cliente">
                                      <button type="button" class="btn btn-info col-lg-2 col-md-2 col-sm-4" onclick="agregar_producto">Agregar o buscar</button>
                                  </div>
                                    ...
                                    <table class="table table-bordered mb-0">
                                        ...
                                        <tbody id="contenido_tabla">
                                            ...
                                            foreach ($array_productos as $key => $value) {
                                                   // key =>id  value => catidad
                                                $consulta ="SELECT * FROM producto WHERE id='$key'";
                                                $ejscutar =mysqli_query($conexion, $consulta);
...
<!--Fin de Contenido-->
    ...
    <!-- App js -->
    <script src="plantilla/Admin/vertical/assets/js/theme.js"></script>ç
    ...
    <script>
        function agregar_producto(){
            ...
            $.ajax({
                type:"POST",
                url:"operaciones/agregar_producto",
                data:{cod:codigo},
                success: function(r){
