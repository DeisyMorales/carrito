                    ...
                    <div class="card">
                        ...
                        <form action="Operaciones/registrar_usuario.php" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" name="cantidad" class="form-control col-lg-4 col-md-4 col-sm-12" 
                                required>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-md-3 col-sm-12">Descuento: </label>
                                <input type="number" name="descuento" class="form-control col-lg-9 col-md-9 col-sm-12" 
                                required>
                            </div>
                            <div class="form-group row">
