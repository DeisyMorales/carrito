                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="number" id="simpleinput" class="form-control" placeholder="Ingrese tu dni">
                                        </div>

                                        <div class="form-group">
                                            <label for="simpleinput">Apellidos y Nombres</label>
                                            <input type="text" id="simpleinput" class="form-control" placeholder="Ingrese tu Apellido y Nombres">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="simpleinput" class="form-control" placeholder="Ingrese tu telefono">
                                        </div>
